...
function buildSubscriptionPayload({ subscriptionId, user }) {
    ...
    const planName = process.env.SUBSCRIPTION_PLAN_NAME || 'Floak Pro';
    ...
    return {
        ...
        customer_details: {
            customer_name: user.name || 'Floak Student',
            customer_email: process.env.CASHFREE_DEFAULT_CUSTOMER_EMAIL || `${subscriptionId.toLowerCase()}@floak.local`,
